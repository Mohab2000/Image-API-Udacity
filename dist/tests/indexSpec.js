...
describe('checks endpoints for images', function () {
    it('gets the end point for images /images?filename=fjord&height=100&width=100', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/image?filename=fjord&height=100&width=100')];
                case 1:
                    response = _a.sent();
                    setTimeout(function () {
                        expect(response.status).toBe(200);
